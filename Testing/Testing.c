...
int main()
{
	...
	u8 key[] = { 0x11, 0x22, 0x33, 0x44, 0x55, 0x66, 0x77, 0x88, 0x88, 0x77, 0x66, 0x55, 0x44, 0x33, 0x22, 0x11 }; //tool one
	...
	u8 RAND[] = { 0x11, 0x22, 0x33, 0x44, 0x55, 0x66, 0x77, 0x88, 0x88, 0x77, 0x66, 0x55, 0x44, 0x33, 0x22, 0x11 }; //tool one
	...
	u8 SQN[6];// = { 0x11,0x22,0x33,0x44,0x55,0x66 };
	u8 AMF[] = { 0x11,0x22 };
	...
	u8 op[] = { 0x11, 0x22, 0x33, 0x44, 0x55, 0x66, 0x77, 0x88, 0x88, 0x77, 0x66, 0x55, 0x44, 0x33, 0x22, 0x11 }; //tool one
	...
	u8 sqnXak[] = { 0xE8, 0x62, 0xC0, 0x6F, 0x46, 0xAB }; //new
