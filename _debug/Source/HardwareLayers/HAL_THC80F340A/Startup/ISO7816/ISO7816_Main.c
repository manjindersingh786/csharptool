...
const 	BYTE	CHIP_SW[14] = {0x90,0x00,0x6D,0x00,0x6C,0x00,0x65,0x01,0x6A,0x00,0x65,0x04,0x6E,0x00};
...
extern uMonoByte getMemoryConfig(puMonoByte pumbData);
//========================================================
...
{	
		ISO7816_TxByte(CHIP_SW[ptr]);
		ISO7816_TxByte(CHIP_SW[ptr+1]);
		CLA = ISO7816_RxByte();
}
